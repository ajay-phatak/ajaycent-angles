...
<aside class="post-update">
	<span class="label">Update · September 11, 2026</span>
	The chart now runs through September 4, 2026, the latest week EIA has reported, which is
	past where this piece was written. The drawdown did not stop, but it has nearly stalled.
	The reserve fell to 286.6 million barrels on August 28 and <strong>285.4 million on
	September 4</strong> — draws of 3.1 and 1.2 million barrels, after 6.1, 5.3 and 3.7 in the
	weeks before. That is 130.0 million barrels drawn since the March peak, about
	<strong>80% of the usable reserve</strong>, not the 61% the numbers below describe,
	leaving roughly 33 million barrels above the statutory floor. Price did not stall with it:
	Cushing spot closed August at an $83.90 monthly average and then jumped to $91.18 in the
	week ending September 4, its highest since May, while the year-out contract averaged
	$71.68 in August and $72.27 that week. It still has not followed.
</aside>
