...
<aside class="post-update">
	<span class="label">Update · September 2, 2026</span>
	The chart now runs through August 21, 2026, the latest week EIA has reported, which is
	past where this piece was written. The drawdown did not stop. The reserve fell to 298.7
	million barrels on August 7, 293.4 million on August 14, and <strong>289.7 million on
	August 21</strong>. That is 125.7 million barrels drawn since the March peak — about
	<strong>77% of the usable reserve</strong>, not the 61% the numbers below describe —
	leaving roughly 37 million barrels above the statutory floor. The weekly draw does keep
	easing: 6.1 million barrels, then 5.3, then 3.7. Spot averaged $83.45 across the three
	August weeks reported so far, back near its July high, and the year-out contract averaged
	$71.42 over the same stretch. It still has not followed.
</aside>
