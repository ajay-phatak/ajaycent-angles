...
> **Update, August 5:** The chart now runs through the end of July, which is past where
> this piece was written. The drawdown did not stop. The reserve fell to 311.4 million
> barrels on July 17, 307.7 million on July 24, and **304.8 million on July 31**. That is
> 110.6 million barrels drawn since the March peak — about **68% of the usable reserve**,
> not the 61% the numbers below describe — leaving roughly 52 million barrels above the
> statutory floor. Spot averaged $80.46 across July and peaked at $88.58 in the week
> ending July 24. The year-out contract averaged $70.50 and still did not follow.
