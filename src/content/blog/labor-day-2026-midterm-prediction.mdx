...
| Key | 2026 | |
|---|---|---|
| Approval at or above 50% | **FALSE** | 38.4% approve, 58.4% disapprove |
| Generic ballot within 2 points | **FALSE** | Democrats +5.7 and climbing since March 2025 |
| No recession | TRUE | ~2% growth, no recession |
| Cost of living isn't the dominant issue | **FALSE** | affordability is the top grievance in every survey |
| Not losing special elections | **FALSE** | Democrats overperformed in 36 of 43 measurable races |
| No retirement wave | **FALSE** | 36 Republican House retirements, a record |
| Redistricting favors the president's party | TRUE | seven Republican-drawn maps net about +15; California and Utah give six back |
| No unpopular war | **FALSE** | [Iran](/blog/state-of-the-iran-war) |
| Blame is shared | **FALSE** | Republicans hold the House, the Senate, and the presidency |
| No weak marquee nominees | **FALSE** | Paxton in Texas |
